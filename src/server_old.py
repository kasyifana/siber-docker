    ...
    def _register_handlers(self):
        ...
        async def handle_list_tools() -> list[Tool]:
            ...
            return [
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "scan_type": {
                                "type": "string",
                                "description": "Type of scan (quick, full, stealth)",
                                "default": "quick"
                            }
                        },
                        "required": ["target"]
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "database": {
                                "type": "string",
                                "description": "Database type (auto, mysql, postgres, mssql)",
                                "default": "auto"
                            }
                        },
                        "required": ["url"]
                ...
                Tool(
                    name="web_vuln_scan",
                    description="Comprehensive web vulnerability scan using Nikto",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "url": {
                            ...
                            "scan_depth": {
                                "type": "string",
                                "description": "Depth of scan (quick, standard, thorough)",
                                "default": "standard"
                            }
                        },
                        "required": ["url"]
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "parameters": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": "List of parameters to test"
                            },
                            "payload_type": {
                                "type": "string",
                                "description": "Type of XSS payloads (reflected, stored, dom, all)",
                                "default": "all"
                            }
                        },
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "method": {
                                "type": "string",
                                "description": "Enumeration method (dns, certificate, brute, all)",
                                "default": "all"
                            }
                        },
                        "required": ["domain"]
                ...
                Tool(
                    ...
                    description="Check security headers of target website",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "url": {
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "scope": {
                                "type": "string",
                                "description": "Audit scope (quick, standard, thorough)",
                                "default": "standard"
                            }
                        },
                        "required": ["target"]
                ...
                Tool(
                    ...
                    description="Generate detailed report from scan results",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "scan_id": {
                            ...
                            "format": {
                                "type": "string",
                                "description": "Report format (markdown, html, pdf, json)",
                                "default": "markdown"
                            }
                        },
                        "required": ["scan_id"]
